	...
	*/
	...
	protected function set_scripts()
	{
	  ...
	  $css = array(
			...
			'assets/grocery_crud/css//jquery_plugins/chosen/chosen.css',
	  ...
	  $js  = array(
			...
			'assets/grocery_crud/js/jquery_plugins/jquery.fancybox-1.3.4.js',
			'assets/grocery_crud/js/jquery_plugins/jquery.easing-1.3.pack.js',
			'assets/grocery_crud/js//jquery_plugins/jquery.chosen.min.js',
